...
import { Button, ButtonGroup, Divider, LegacyCard, Tabs, Tooltip } from "@shopify/polaris";
        ...
        {internetStatus && internetStatus ? (
          <div className="appdesign-body-side-menu-icons">
            ...
            <Tooltip content="Branding" preferredPosition="mostSpace">
              <div
                className={`appdesign-icon-btn ${activeSideNavIndex === 1 ? "active" : ""
                  }`}
            ...
            <Tooltip content="Navigation" preferredPosition="mostSpace">
              <div
                className={`appdesign-icon-btn ${activeSideNavIndex === 2 ? "active" : ""
                  }`}
            ...
            {internetStatus ? (
              <div className="appdesign-tab-menu">
                <div className="appdesign-tabs-buttons-div">
                  <button
                    className={`appdesign-tab-btn ${activeIndex === 0 ? "active" : ""
                      }`}
                  ...
                  <button
                    className={`appdesign-tab-btn ${activeIndex === 1 ? "active" : ""
                      }`}
                    onClick={() => handleButtonClick(1)}
                  >
                    Product page
                  ...
                  <button
                    className={`appdesign-tab-btn ${activeIndex === 2 ? "active" : ""
                      }`}
                  ...
                  <button
                    className={`appdesign-tab-btn ${activeIndex === 3 ? "active" : ""
                      }`}
                  ...
                  <button
                    className={`appdesign-tab-btn ${activeIndex === 4 ? "active" : ""
                      }`}
